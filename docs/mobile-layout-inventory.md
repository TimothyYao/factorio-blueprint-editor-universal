...
| ------------------------------------------------ | ----------------------------------------------- | -------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Action rail** (`#action-toolbar`)              | **left gutter** (below the logo + corner btns)  | 44px flush squares + labels; ⋯ overflow      | 4       | **Mobile only**; reserves the left band of `G.safeArea` (`setViewportInsets`) — world shows through below its last button; **2-col portrait / 3-col landscape** (matching the corner-button grid above, one aligned lattice), rest in ⋯. **Mode-gated** (#33): only live buttons show |
...
| **Corner buttons** (`#buttons`)                  | **top-left**, under the logo                    | desktop text rows; **mobile 44×44 squares**  | 5       | Github / Settings / **Library** (#50; Discord dropped); **fold into the rail** on mobile: flush dark squares on the **same column grid** as the rail (2 portrait / 3 landscape), so the block costs 1–2 rows instead of a three-tall stack                                            |
